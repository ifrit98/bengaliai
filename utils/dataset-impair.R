...
# TODO: Capsule routing network after simple baseline CNN model investigation
# TODO: Create tf.functions of python functions for dataset.map calls
# TODO: Create wrapper for augmix in R to call upon dataset creation -> keep originals too?
